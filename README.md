...
| `0.9.8` | Exact release, e.g. `ghcr.io/syngnat/gonavi-web-server:0.9.8` |
| `0.9` | Newest patch of a minor line |
...
pointer and is not a stable anchor. Tags carry no `v` prefix — the Git tag is
`v0.9.8`, the image tag is `0.9.8`.
